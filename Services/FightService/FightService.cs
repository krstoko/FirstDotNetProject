...
namespace FirstDotNetProject.Services.FightService
{
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> WeaponAttaack(WeaponAttackDto request)
        {
            var response = new ServiceResponse<AttackResultDto>();
            try
            {
                ...
                var opponent = await _context.Characters.FirstOrDefaultAsync(c => c.Id == request.OppnentId);
